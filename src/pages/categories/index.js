                ...
                <Col sm={8} className='colFlex-1'>
                    <Tab.Content>
                        <Tab.Pane eventKey="first">
                            <div className='sc-d68ddef2-2 derWoS overflow-auto' style={{ height: 80 + "vh" }}>
                                <div className='sc-39ccbf76-0 eObXqj'>
                                    ...
                                    <div className='sc-dc3f2d0b-0 frfUCM' >
                                        {pDataCate.data.map((item) => {
                                            return <Link className='text-decoration-none'><div className="sc-dc3f2d0b-1 dDGxAs" key={item.id}><img src={item.cardimg} alt="5% Unlimited Cashback" className="sc-b51db3f-1 iCVkuj" /><p className="sc-dc3f2d0b-2 cyOHYd">{item.title}</p></div></Link>
                                        })}
                                    </div>
