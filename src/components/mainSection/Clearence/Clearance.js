...
export const Clearance = ({ clearData }) => {
    var settings = {
        dots: false,
        infinite: false,
        speed: 500,
    ...
    return <React.Fragment >
        <div className="bg-lights pt-1 px-3">
            <div className="sc-iqcoie btLjaq">
                <div fontSize="24" className="sc-crXcEl fIdVYV">
                    <h2 className="truncate-title-header">Clearance deals</h2>
                </div>
                <div className="sc-fnykZs hRppEE">
                    <Link>VIEW ALL</Link>
                </div>
            </div>
